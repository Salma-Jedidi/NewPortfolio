    ...
    <nav>
      <div id="home">
        ...
        <div className="profile_name">
          ...
          <div className="contact_info">
            <img src="/NewPortfolios/assets/phone.png" alt="Phone icon" />
            +21623777108
          </div>
        </div>
        <div className="topdiv">
          <Link className="topmenu" to="/">Accueil</Link>
          <img src="/NewPortfolios/assets/EN.png" className="flag-icon" alt="English" />
          <Link className="topmenu" to="/en">EN</Link>
          <a className="topmenu">|</a>
          <img src="/NewPortfolios/assets/FR.png" className="flag-icon" alt="French" />
